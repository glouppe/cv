...
\usepackage[a4paper, lmargin=2in, rmargin=1.5in, tmargin=1in, bmargin=1.5in, footskip=0.5in]{geometry}
...
\begin{cv}{\spacedallcaps{Gilles Louppe}}\vspace{3em}

\noindent\spacedlowsmallcaps{Personal Information}\vspace{1em}

\NewEntry{}{Born in Belgium, on April 26, 1987. Married.}{}
...
\NewEntry{}{%
As a researcher, my far ambition is to unlock discoveries of a new kind by
...
inference models, and developments towards the automatization of science.
}\vspace{2em}
...
\NewPublication{2017}{23}{QCD-aware Recursive Neural Networks for Jet Physics.}{%
Gilles Louppe, Kyunghyun Cho, Kyle Cranmer.
{\it In preparation for early 2017.}}

\NewPublication{2016}{22}{Learning to Pivot with Adversarial Networks.}{%
Gilles Louppe, Michael Kagan, Kyle Cranmer.
{\it Pre-print available. To be submitted to ICML 2017.}
...
{\it Pre-print available. Submitted to JASA.}
...
\NewPublication{}{17}{Visualization of Publication Impact.}{%
