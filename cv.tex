...
\NewPublication{pre-prints}{3}{QCD-aware Recursive Neural Networks for Jet Physics.}{%
...
{\it  Submitted to International Conference on Machine Learning 2017. Pre-print available.}
...
\NewPublication{talks}{29}{Bayesian Optimization with Scikit-Optimize.}{%
PyData Amsterdam, The Netherlands.
April 8, 2017.
[\href{https://t.co/WXKf6IRXe5}{Materials}]}
...
IML Workshopr, CERN, Switzerland
March 21, 2017.
...
\NewEntryFull{2017--Present}{Paul Klein (MSc student)}{Supelec (France)}

\Description{CERN intern. Generative models for particle detectors.}

\NewEntryFull{2016--Present}{Manoj Kumar (MSc student)}{New York University (USA)}
